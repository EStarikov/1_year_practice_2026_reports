...
В отличие от традиционных форматов (CSR, COO), деревья квадрантов позволяют эффективно выполнять рекурсивные операции за счёт логарифмической сложности доступа и возможности схлопывания одинаковых значений в один лист (UserValue(v)). Данная структура хорошо согласуется с функциональной парадигмой языка F\# и обеспечивает неизменяемость данных.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/time_comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{images/memory_comparison.pdf}
...
Экспериментальное исследование показало, что разреженные матрицы на больших размерах (1024×1024) работают в 100–120 раз быстрее плотных и потребляют в 60 раз меньше памяти. Выигрыш растёт с увеличением размера матрицы и уменьшением плотности.
